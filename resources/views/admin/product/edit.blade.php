        ...
        <form action="{{ route('admin.product.update', $product->id) }}" method="post">
            ...
            <div class="form-group">
                ...
                <select name="id_jenis" id="id_jenis" class="form-control select2" required="">
                    ...
                    <option {{ $product->id_jenis == $kategori->id ? 'selected' : ''}} value="{{ $kategori->id }}">  {{ $kategori->nama_kategori }}</option>
            ...
            <div class="form-group">
                ...
                <input type="datetime-local" name="created_at" id="created_at" class="form-control" value="{{Carbon\Carbon::parse($product->created_at)->format('Y-m-d').'T'.Carbon\Carbon::parse($product->created_at)->format('H:i:s')}}">
