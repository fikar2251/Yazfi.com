    ...
    <section class="sheet padding-1mm">
        <div class="header-doc">
            ...
            <div class="title" style="text-align: center; font-family: Arial, Helvetica, sans-serif; margin-top: 20px;">
                <span style="text-transform: uppercase;">SKY DENTAL {{ $appointment->cabang->nama }}</span><br>
        ...
        <table style=" font-size: 14px; margin-top: 20px;" cellspacing="0" width="100%">
            ...
            <tr>
                ...
                <td></td>
                <td style="text-align: end;">{{ $appointment->status_pembayaran == 1 ? 'Lunas' : number_format($subtotal + $pajak -$appointment->rincian->sum('nominal')) }}</td>
            </tr>
        </table>
