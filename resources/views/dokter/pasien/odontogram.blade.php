    ...
    <div class="col-md-12">
        ...
        <div class="card">
            <div class="card-header" style="display: flex;">
                ...
                <a href="{{ route('dokter.pasien.cekfisik', $customer->id) }}" class="btn btn-sm btn-success">Pemeriksaan Fisik</a>
            </div>
                ...
                <form action="{{ route('ketodonto.store') }}" method="post">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <a href="{{ route('dokter.pasien.cetakodonto', $customer->id) }}" class="btn btn-sm btn-primary"><i class="fa fa-print"></i> Cetak Pemeriksaan</a>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <a href="{{ route('dokter.pasien.cetakriwayat', $customer->id) }}" class="btn btn-sm btn-danger mb-3"><i class="fa fa-print"></i> Cetak Riwayat</a>
