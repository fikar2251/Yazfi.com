    ...
    <div class="col-md-12">
        ...
        <div class="card">
            <div class="card-header d-flex">
                ...
                <a href="{{ route('dokter.pasien.odontogram', $customer->id) }}" class="btn btn-sm btn-success">Back</a>
            </div>

            <div class="card-body">
                <form action="{{ route('dokter.pasien.storefisik', $customer->id) }}" method="post">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
