                                    ...
                                    <li>
                                        <div class="form-group">
                                            <label for="id_supplier">Nama Vendor <span
                                                    style="color: red">*</span></label>
                                            <input type="text" value="{{ $pur->name }}" id="supplier_id"
                                                class="form-control">
                                            <input type="hidden" name="id_supplier" value="{{ $pur->supplier_id }}"
                                                id="supplier_id" class="form-control">
                                    ...
                                    <li>
                                        <div class="form-group">
                                            <label for="no_po_vendor">Number PO Vendor <span
                                                    style="color: red">*</span></label>
                                            <input type="text" name="no_po_vendor" value="{{ $pur->invoice}}"
                                    ...
                                    <li>
                                        <div class="form-group">
                                            <label for="nilai_invoice">Nilai Invoice <span
                                                    style="color: red">*</span></label>
                                            <input type="text" name="nilai_invoice" value="{{ $pur->total }}"
                                                class="form-control">
                                    ...
                                    <li>
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="id_project"
                                              id="id_project" class="form-control" value="{{ $pur->project_id }}">
                            ...
                            <div class="col-sm-6 col-sg-4 m-b-4">
                                <ul class="list-unstyled">
                                    <li>
                                        ...
                                        <input type="hidden" value="{{$pur->nama_barang}}"
                                            ...
                                            <tr style="font-size:12px;">
                                                ...
                                                <td>
                                                    ...
                                                    <input type="hidden" value="{{$barang->id_dokumen}}"
                                                        name="id_dokumen[{{ $loop->iteration }}]" id="id_dokumen"
                                                        required=""
                                                ...
                                                <td>
                                                    <input type="radio" name="pilihan[{{ $loop->iteration }}]"
                                                        ...
                                                        style="width:1.2em;   padding: 0.25em 0.5em;">
                                                ...
                                                <td>
                                                    <input type="text" name="catatan[{{ $loop->iteration }}]"
                                                        id="catatan" required=""
                                                        class="form-control catatan-{{ $loop->iteration }}"
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-sg-4 m-b-4">
                                <ul class="list-unstyled">
                                    <li>
                                        <div class="form-group">
                                            <label for="no_po_vendor">Number PO <span
                                                    style="color: red">*</span></label>
                                            <input type="text" name="no_po_vendor" value="{{$nourutPO}}"
                                                id="no_po_vendor" class="form-control" readonly>
                            ...
                            <div class="col-sm-6 col-sg-4 m-b-4">
                                <ul class="list-unstyled">
                                    <li>
                                        <div class="form-group">
                                            <label for="nama_barang">Nama Barang <span
                                                    style="color: red">*</span></label>
                                    ...
                                    <table class="table table-bordered  report">
                                        ...
                                        <tbody>
                                            ...
                                            <tr style="font-size:12px;">
                                                ...
                                                <td>
                                                    <input type="text" name="keterangan[{{ $loop->iteration }}]"
