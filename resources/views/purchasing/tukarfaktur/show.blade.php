                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="dashboard-logo">
                                    ...
                                    <hr width="330%" color=" black">
                                </div>
                            </div>
                            <div class="col-md-8">
                                <h6 style="font-size: 15px; color:black; margin-top: 20px;  font-family: Times New Roman, Times, serif;"><strong>TANDA TERIMA <br> TUKAR FAKTUR</strong></h6>
                            </div>
                        </div><br>
                        <br />
