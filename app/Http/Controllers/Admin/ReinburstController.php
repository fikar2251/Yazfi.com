...
class ReinburstController extends Controller
{
    public function index(Reinburst $reinburst)
    {
        if (request('from') && request('to')) {
            ...
            $reinbursts = Reinburst::groupBy('nomor_reinburst')->get();
        }
    ...
    public function show(Reinburst $reinburst)
    {
        ...
        return view('admin.reinburst.show', compact('reinburst'));
    }
    ...
    public function edit(Pengajuan $pengajuan)
    {
        ...
        return view('admin.reinburst.edit', compact('perusahaans', 'barangs', 'pengajuan', 'pengajuans', 'peng'));
    }
    ...
    {
        $reinburst = Reinburst::where('nomor_reinburst', $reinburst->nomor_reinburst)->get();

        foreach ($reinburst as $pur) {
            RincianReinburst::where('id', $pur->id)->delete();
            $pur->delete();
        }
