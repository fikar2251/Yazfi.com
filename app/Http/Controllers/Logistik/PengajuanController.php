...
class PengajuanController extends Controller
{
    public function index(Purchase $purchase)
    {
        if (request('from') && request('to')) {
            ...
            $purchase = Purchase::groupBy('invoice')->whereBetween('created_at', [$from, $to])->get();
        } else {
            $purchases = DB::table('purchases')
            ->leftjoin('roles','roles.id','=','purchases.id')
        ...
        return view('logistik.pengajuan.index', compact('purchases','users'));
    }
    ...
    public function create(Purchase $purchase)
    {
        ...
        return view('logistik.pengajuan.create', compact('purchases', 'suppliers', 'barangs', 'project','purchase'));
    }
